...
export default component$(() => {
  return (
    <section class='py-20 bg-purple-600 sm:py-28 lg:py-32 md:-mt-48'>
      ...
      <div class='px-4 mx-auto lg:max-w-screen-2xl sm:px-6'>
        ...
        <div class='grid gap-8 mt-12 md:gap-8 sm:gap-6 md:mt-14 lg:mt-16 xl:mt-20 2xl:mt-24 xl:grid-cols-4 sm:grid-cols-2 2xl:gap-12 lg:gap-6'>
          ...
          <blockquote class='px-8 py-8 transition duration-300 ease-in-out bg-yellow-200 sm:px-6 md:px-8 lg:px-5 2xl:px-8 rounded-3xl'>
            <img src='images/testimonial-01.jpg' class='object-cover w-20 h-20 border-2 border-yellow-300 rounded-full filter drop-shadow-2xl' alt='Testimonial 01' />
            ...
            <p class='mt-5 text-lg text-purple-800'>
              "Donec sollicitudin molestie malesuada. Donec rutrum congue leo eget malesuada. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus."
            </p>
          </blockquote>

          <blockquote class='px-8 py-8 transition duration-300 ease-in-out bg-purple-25 sm:px-6 md:px-8 lg:px-5 2xl:px-8 rounded-3xl'>
            <img src='images/testimonial-02.jpg' class='object-cover w-20 h-20 border-2 border-yellow-300 rounded-full filter drop-shadow-2xl' alt="Testimonial 02" />
            <p class='mt-3 text-lg font-bold text-purple-900'>
              Kevin Lee
            </p>
          ...
          <blockquote class='px-8 py-8 transition duration-300 ease-in-out bg-rose-50 sm:px-6 md:px-8 lg:px-5 2xl:px-8 rounded-3xl'>
            <img src='images/testimonial-03.jpg' class='object-cover w-20 h-20 border-2 border-yellow-300 rounded-full filter drop-shadow-2xl' alt="Testimonial 03" />
            <p class='mt-3 text-lg font-bold text-purple-900'>
              Alexa Grasso
            </p>
          ...
          <blockquote class='px-8 py-8 transition duration-300 ease-in-out bg-blue-50 sm:px-6 md:px-8 lg:px-5 2xl:px-8 rounded-3xl'>
            <img src='images/testimonial-04.jpg' class='object-cover w-20 h-20 border-2 border-yellow-300 rounded-full filter drop-shadow-2xl' alt="Testimonial 04" />
            <p class='mt-3 text-lg font-bold text-purple-900'>
              Marina Rodriguez
            </p>
