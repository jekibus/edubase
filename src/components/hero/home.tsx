...
<div class='max-w-screen-xl mx-auto lg:grid lg:grid-cols-12 lg:gap-8' x-data="{ modalOpen: false }" >
  ...
  <div class='flex flex-col items-center justify-center lg:items-start lg:col-span-6'>
    ...
    <div class='flex flex-col items-center mt-8 overflow-hidden sm:flex-row'>
      ...
      <button class='mt-6 text-lg font-medium text-purple-900 bg-purple-200 sm:mt-0 sm:ml-6 btn hover:text-white hover:bg-purple-600 group' onClick$={()=> modalOpen.value = true}>
  ...
  <div class='flex flex-col justify-center max-w-3xl mx-auto mt-16 lg:mt-0 lg:max-w-none lg:col-span-6'>
    <div class='relative'>
      ...
      <div class='absolute inset-0 flex items-center justify-center'>
        ...
        <button class="relative z-10 flex items-center justify-center w-20 h-20 bg-white rounded-full outline-none opacity-90" onClick$={() => modalOpen.value = true}>
  ...
  { modalOpen.value && 
  <div class="fixed inset-0 z-10 w-full h-full px-4 overflow-hidden transition duration-150 ease-linear" aria-modal="true" x-show="modalOpen" onClick$={() => modalOpen.value = false}>
    <div 
    ...
    <div 
      ...
      >
      <div class='w-full max-w-6xl max-h-full overflow-auto bg-white rounded-2xl' onClick$={() => modalOpen.value = false} >
        <div class="relative aspect-w-16 aspect-h-9">
          <div class="text-lg bg-white p-5 text-center">Sorry, The video is not available yet</div>
        </div>
      </div>
    </div>
  </div>
